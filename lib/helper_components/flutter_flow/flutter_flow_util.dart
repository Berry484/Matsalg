...
const kTextValidatorUsernameRegex =
    r'^[a-zA-ZæøåÆØÅ][a-zA-Z0-9æøåÆØÅ_-]{1,16}$';

const kTextValidatorNormalnameRegex =
    r'^[a-zA-ZæøåÆØÅ][a-zA-Z0-9æøåÆØÅ\s_-]{0,16}$';

// https://stackoverflow.com/a/201378
const kTextValidatorEmailRegex =
    "^(?:[a-zA-Z0-9æøåÆØÅ!#\$%&'*+/=?^_`{|}~-]+(?:\\.[a-zA-Z0-9æøåÆØÅ!#\$%&'*+/=?^_`{|}~-]+)*|\"(?:[\\x01-\\x08\\x0b\\x0c\\x0e-\\x1f\\x21\\x23-\\x5b\\x5d-\\x7f]|\\\\[\\x01-\\x09\\x0b\\x0c\\x0e-\\x7f])*\")@(?:(?:[a-zA-Z0-9æøåÆØÅ](?:[a-zA-Z0-9æøåÆØÅ]*[a-zA-Z0-9æøåÆØÅ])?\\.)+[a-zA-Z0-9æøåÆØÅ](?:[a-zA-Z0-9æøåÆØÅ]*[a-zA-Z0-9æøåÆØÅ])?|\\[(?:(?:(2(5[0-5]|[0-4][0-9])|1[0-9][0-9]|[1-9]?[0-9]))\\.){3}(?:(2(5[0-5]|[0-4][0-9])|1[0-9][0-9]|[1-9]?[0-9])|[a-zA-Z0-9æøåÆØÅ]*[a-zA-Z0-9æøåÆØÅ]:(?:[\\x01-\\x08\\x0b\\x0c\\x0e-\\x1f\\x21-\\x5a\\x53-\\x7f]|\\\\[\\x01-\\x09\\x0b\\x0c\\x0e-\\x7f])+)\\])";

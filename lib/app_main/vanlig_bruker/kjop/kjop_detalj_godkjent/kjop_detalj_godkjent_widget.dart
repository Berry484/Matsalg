...
import 'kjop_detalj_godkjent_model.dart';
...
class KjopDetaljGodkjentWidget extends StatefulWidget {
  ...
  State<KjopDetaljGodkjentWidget> createState() =>
      _KjopDetaljGodkjentWidgetState();
}

class _KjopDetaljGodkjentWidgetState extends State<KjopDetaljGodkjentWidget> {
  late KjopDetaljGodkjentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => KjopDetaljGodkjentModel());
  }

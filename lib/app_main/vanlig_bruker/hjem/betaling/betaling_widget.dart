            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(12.0, 20.0, 0.0, 15.0),
                    child: Text(
                      'Matvare',
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        context.pushNamed('KjopDetaljGodkjent');
                      },
                      child: Material(
                  ...
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(12.0, 0.0, 0.0, 40.0),
                    child: Column(
                      mainAxisSize: MainAxisSize.max,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                              ...
                              Align(
                                ...
                                child: Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 20.0, 20.0),
                                  child: TextFormField(
                                    controller: _model.antallStkTextController,

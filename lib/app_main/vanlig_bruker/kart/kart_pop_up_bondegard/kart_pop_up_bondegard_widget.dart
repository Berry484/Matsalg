...
import 'kart_pop_up_bondegard_model.dart';
...
class KartPopUpBondegardWidget extends StatefulWidget {
  ...
  State<KartPopUpBondegardWidget> createState() =>
      _KartPopUpBondegardWidgetState();
}

class _KartPopUpBondegardWidgetState extends State<KartPopUpBondegardWidget> {
  late KartPopUpBondegardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => KartPopUpBondegardModel());
  }

...
import '/app_main/tom_place_holders/ingen_kjop_matvarer/ingen_kjop_matvarer_widget.dart';
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      ...
                                      if (removeme2.isEmpty) {
                                        return const IngenKjopMatvarerWidget();
                                      }
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemBuilder: (context, removeme2Index) {
                                          final removeme2Item =

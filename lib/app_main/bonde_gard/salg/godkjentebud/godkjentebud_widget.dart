...
class _GodkjentebudWidgetState extends State<GodkjentebudWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Padding(
        padding: const EdgeInsetsDirectional.fromSTEB(15.0, 4.0, 5.0, 16.0),
        child: Column(
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Padding(
                        padding:
                            const EdgeInsetsDirectional.fromSTEB(0.0, 12.0, 4.0, 0.0),
                        child: Text(
                          '150',
                          textAlign: TextAlign.end,
                          style: FlutterFlowTheme.of(context)
                ...
                Padding(
                  padding: const EdgeInsetsDirectional.fromSTEB(5.0, 12.0, 0.0, 0.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                    mainAxisAlignment: MainAxisAlignment.start,
                    crossAxisAlignment: CrossAxisAlignment.end,

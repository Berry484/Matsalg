...
import 'salg_detalj_model.dart';
export 'salg_detalj_model.dart';

class SalgDetaljWidget extends StatefulWidget {
  const SalgDetaljWidget({
    super.key,
    this.matvare,
  });
...
class _SalgDetaljWidgetState extends State<SalgDetaljWidget> {
  late SalgDetaljModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SalgDetaljModel());
  }
                                    ...
                                    builder: (context) {
                                      return GestureDetector(
                                        ...
                                        child: Padding(
                                          ...
                                          child: const SalgBrukerInfoWidget(),
                                        ),
                                      );
                                    },

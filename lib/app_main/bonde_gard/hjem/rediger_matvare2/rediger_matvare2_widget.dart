...
import 'rediger_matvare2_model.dart';
export 'rediger_matvare2_model.dart';

class RedigerMatvare2Widget extends StatefulWidget {
  const RedigerMatvare2Widget({
    super.key,
    this.matvare,
  });
  ...
  @override
  State<RedigerMatvare2Widget> createState() => _RedigerMatvare2WidgetState();
}

class _RedigerMatvare2WidgetState extends State<RedigerMatvare2Widget>
    with TickerProviderStateMixin {
  late RedigerMatvare2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RedigerMatvare2Model());
    ...
    _model.produktMinMengdeTextController ??= TextEditingController();
    _model.produktMinMengdeFocusNode ??= FocusNode();
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.produktNavnTextController?.text = 'MatvareInital';
          _model.produktBeskrivelseTextController?.text = 'BeskrivelseInital';
          _model.produktPrisSTKTextController?.text = '0';
          _model.produktPrisKgTextController?.text = '0';
          _model.produktMinMengdeTextController?.text = '0';
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.produktBeskrivelseTextController,
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          20.0, 0.0, 0.0, 0.0),
                                      child: Text(
                                        'Du kan velge mellom \npris pr stk, pr kg eller pr gram',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Open Sans',
                                                      ...
                                                      padding:
                                                          const EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  20.0),
                                                      child: Text(
                                                        'NB! pris pr. kg lar kunder velge mengde selv.\n\nVelg  pris pr. stk hvis du kun selger i bestemte mengder. ',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyMedium
                                                      ...
                                                      padding:
                                                          const EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  20.0),
                                                      child: Text(
                                                        'Skriv minste mengden du selger per kunde \nf.eks. \'kunden må minst kjøpe 0,5 kg\'',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyMedium
                                                  ...
                                                  Stack(
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: TextFormField(
                                                          controller: _model
                                                              .produktMinMengdeTextController,
                                                          focusNode: _model
                                                              .produktMinMengdeFocusNode,
                                                          onChanged: (_) =>
                                                              EasyDebounce
                                                                  .debounce(
                                                            '_model.produktMinMengdeTextController',
                                                            const Duration(
                                                                milliseconds:
                                                                    300),
                                                            () => safeSetState(
                                                          ...
                                                          decoration:
                                                            ...
                                                            alignLabelWithHint:
                                                                false,
                                                            hintText:
                                                                'Skriv minste mengden du selger',
                                                            hintStyle:
                                                                FlutterFlowTheme.of(
                                                                        context)
                                                                    .labelMedium
                                                              ...
                                                              padding:
                                                                  const EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          10.0),
                                                              child: Text(
                                                                'Dette er adressen hvor matvaren skal hentes.',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
                                                                    .override(
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      child:
                                                                          TextFormField(
                                                                        controller:
                                                                            _model.gateNummerTextController,
                                                                        focusNode:
                                                                  ...
                                                                  Expanded(
                                                                    child:
                                                                      ...
                                                                      child:
                                                                          TextFormField(
                                                                        controller:
                                                                            _model.postNummerTextController,
                                                                        focusNode:

...
import 'rediger_antall2_model.dart';
export 'rediger_antall2_model.dart';
...
class _RedigerAntall2WidgetState extends State<RedigerAntall2Widget> {
  late RedigerAntall2Model _model;

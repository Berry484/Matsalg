...
import 'leg_ut_mat2_model.dart';
export 'leg_ut_mat2_model.dart';

class LegUtMat2Widget extends StatefulWidget {
  const LegUtMat2Widget({super.key});

  @override
  State<LegUtMat2Widget> createState() => _LegUtMat2WidgetState();
}

class _LegUtMat2WidgetState extends State<LegUtMat2Widget>
    with TickerProviderStateMixin {
  late LegUtMat2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LegUtMat2Model());

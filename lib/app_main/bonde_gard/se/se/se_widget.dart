...
import 'se_model.dart';
export 'se_model.dart';

class SeWidget extends StatefulWidget {
  const SeWidget({super.key});

  @override
  State<SeWidget> createState() => _SeWidgetState();
}

class _SeWidgetState extends State<SeWidget> {
  late SeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SeModel());
          ...
          body: SafeArea(
            ...
            child: Column(
              ...
              children: [
                ...
                wrapWithModel(
                  model: _model.seCustomNavBarModel,
                  updateCallback: () => safeSetState(() {}),
                  child: const SeCustomNavBarWidget(),
                ),
              ],
            ),
          ),

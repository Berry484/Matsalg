  ...
  Future<void> _checkUser() async {
    try {
      ...
      if (token == null) {
        ...
        _brukerinfo = await UserInfoService.checkUser(token, widget.username);
    ...
    try {
      ...
      if (token == null) {
        ...
        if (widget.mine != true && widget.uid != null) {
          _ratings = await RatingService.listRatings(token, widget.uid);
        } else {
          _ratings = await RatingService.listMineRatings(token);
        }

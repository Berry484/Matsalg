...
import 'bought_model.dart';
export 'bought_model.dart';

class BoughtWidget extends StatefulWidget {
  const BoughtWidget({super.key});

  @override
  State<BoughtWidget> createState() => _GodkjentbetalingWidgetState();
}

class _GodkjentbetalingWidgetState extends State<BoughtWidget>
    with TickerProviderStateMixin {
  final scaffoldKey = GlobalKey<ScaffoldState>();
  final animationsMap = <String, AnimationInfo>{};
  late BoughtModel _model;

  @override
  void initState() {
    super.initState();
    _model = createModel(context, () => BoughtModel());

...
import 'package:mat_salg/pages/app_pages/hjem/bruker_page/folg_bruker/folg_bruker_widget.dart';
  ...
  Future<void> _checkUser() async {
    try {
      ...
      if (token == null) {
        ...
        if (widget.bruker != 1) {
          _brukerinfo = await UserInfoService.checkUser(token, widget.uid);
  ...
  Future<void> getUserFood() async {
    try {
      ...
      if (token == null) {
        ...
        _matvarer = await ApiFoodService.getUserFood(token, widget.uid);
        setState(() {

...
import 'package:mat_salg/pages/app_pages/orders/godkjentebud/godkjentebud_widget.dart';
import 'package:mat_salg/pages/app_pages/orders/kjopInfo/budInfo_widget.dart';
  ...
  Future<void> getAll() async {
    try {
      ...
      if (token == null) {
        ...
        _alleInfo = await PurchaseService.getAll(token);
        if (mounted) {
          setState(() {
                                                                      ...
                                                                      Stack(
                                                                        children: [
                                                                          ...
                                                                          Positioned(
                                                                            ...
                                                                            child:
                                                                                Container(
                                                                              width: 25, // Ensure this matches the width of the image
                                                                              height: 25, // Ensure this matches the height of the image
                                                                              decoration: BoxDecoration(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              if (alleInfo.godkjent != true && alleInfo.hentet != true && alleInfo.trekt != true && alleInfo.avvist != true)
                                                                                Padding(
                                                                                  padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 0, 6),
                                                                                  child: Text(
                                                                              ...
                                                                              if (alleInfo.godkjent == true && alleInfo.hentet != true)
                                                                                Padding(
                                                                                  padding: const EdgeInsetsDirectional.fromSTEB(0, 0, 0, 6),
                                                                                  child: Text(
